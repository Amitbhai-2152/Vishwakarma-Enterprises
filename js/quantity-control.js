(()=>{
  ...
  const labels={hi:{quantity:"मात्रा",unit:"प्रति नग MRP",total:"कुल MRP",minus:"मात्रा घटाएँ",plus:"मात्रा बढ़ाएँ",pcs:"नग"},en:{quantity:"Quantity",unit:"MRP per piece",total:"Total MRP",minus:"Decrease quantity",plus:"Increase quantity",pcs:"pcs"}};
  ...
  const refreshMessage=()=>{
    ...
    const text=lang()==="en"?`Hello, I would like to enquire about ${currentProduct.name?.en||"this product"}. Selected size: ${size}. Quantity: ${quantity} ${labels.en.pcs}. Total MRP: ${total}.`:`नमस्ते, मुझे ${currentProduct.name?.hi||"इस उत्पाद"} के बारे में जानकारी चाहिए। चुना गया साइज़: ${size}। मात्रा: ${quantity} ${labels.hi.pcs}। कुल MRP: ${total}।`;
